...
public class CustomerProductGateway implements MessageListener {
    ...
    public CustomerProductGateway(){

    }

    public CustomerProductGateway(String channelName) {
        this.channelName = channelName;
        //should be: CustomerToProduct
        sender = new MessageSenderGateway(channelName);
        receiver = new MessageReceiverGateway("ProductToCustomer");
    ...
    public void onMessage(Message message) {
        try {
            ...
            System.out.println("Something went wrong when receiving a message in the CustomerProductGateway: onMessage" + e.getMessage());
        }
    }
